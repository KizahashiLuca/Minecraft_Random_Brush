...
## Generate sphere
summon minecraft:area_effect_cloud ~-2 ~ ~-1 {Tags:["MRBradius"],NoGravity:1b,Invulnerable:1b,Particle:"block air",Radius:0.5f,Duration:2147483647}
summon minecraft:area_effect_cloud ~-2 ~ ~0 {Tags:["MRBradius"],NoGravity:1b,Invulnerable:1b,Particle:"block air",Radius:0.5f,Duration:2147483647}
summon minecraft:area_effect_cloud ~-2 ~ ~1 {Tags:["MRBradius"],NoGravity:1b,Invulnerable:1b,Particle:"block air",Radius:0.5f,Duration:2147483647}
summon minecraft:area_effect_cloud ~-1 ~ ~-2 {Tags:["MRBradius"],NoGravity:1b,Invulnerable:1b,Particle:"block air",Radius:0.5f,Duration:2147483647}
...
summon minecraft:area_effect_cloud ~-1 ~ ~1 {Tags:["MRBradius"],NoGravity:1b,Invulnerable:1b,Particle:"block air",Radius:0.5f,Duration:2147483647}
summon minecraft:area_effect_cloud ~-1 ~ ~2 {Tags:["MRBradius"],NoGravity:1b,Invulnerable:1b,Particle:"block air",Radius:0.5f,Duration:2147483647}
summon minecraft:area_effect_cloud ~0 ~ ~-2 {Tags:["MRBradius"],NoGravity:1b,Invulnerable:1b,Particle:"block air",Radius:0.5f,Duration:2147483647}
...
## Set block
execute as @e[type=minecraft:area_effect_cloud,tag=MRBradius] at @s unless block ~ ~-1 ~ #mrb:unless run function mrb:brush_ground/set_block
