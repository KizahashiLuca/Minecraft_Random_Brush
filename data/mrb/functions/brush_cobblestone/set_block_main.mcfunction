...
## Set block
execute as @e[type=minecraft:area_effect_cloud,tag=MRBradius] at @s unless block ~ ~-1 ~ #mrb:unless unless block ~ ~-1 ~ #mrb:cobblestone run function mrb:brush_cobblestone/set_block_sub
